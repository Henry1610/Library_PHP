...
<style>
  ...
  .suggest-card-modern {
    background: linear-gradient(120deg, #f8fafd 60%, #eaf6ff 100%);
  }
...
<div class="container py-4">
  ...
  $suggestBooks = array_filter($books, function ($b) use ($excludeIds) {
    return !in_array($b['id'], $excludeIds); });
  ...
  <?php if (!empty($_SESSION['user'])): ?>
    <div class="mb-4 text-center">
      <h2 class="fw-bold" style="font-size:2.1rem;">Xin chào,
        <?= htmlspecialchars($_SESSION['user']['name'] ?? $_SESSION['user']['email']) ?>! 👋</h2>
    ...
    <div class="carousel-inner rounded shadow">
      <div class="carousel-item active">
        <img src="https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&w=1200&q=80"
          class="d-block w-100" style="max-height:340px;object-fit:cover;" alt="Thư viện">
      ...
      <div class="carousel-item">
        <img src="https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=1200&q=80"
          class="d-block w-100" style="max-height:340px;object-fit:cover;" alt="Sách mới">
        <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded">
      ...
      <div class="carousel-item">
        <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80"
          class="d-block w-100" style="max-height:340px;object-fit:cover;" alt="Không gian đọc">
        <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded">
  ...
  <div class="row mb-4">
    <div class="col-12 text-center">
      ...
      <p class="lead">Chúng tôi mang đến cho bạn hàng ngàn đầu sách đa dạng, không gian đọc hiện đại và dịch vụ mượn
        sách tiện lợi. Hãy khám phá, học hỏi và phát triển cùng Thư viện!</p>
    </div>
  </div>
      ...
      <div class="category-marquee-wrapper py-3">
        <div class="category-marquee">
          <?php foreach ($categories as $cat): ?>
            <a href="index.php?action=books&category=<?= $cat['id'] ?>"
              class="btn btn-outline-primary rounded-pill px-4 py-2 fw-bold shadow-sm flex-shrink-0">
        ...
        <form method="post" action="index.php?action=add_to_cart">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="date" class="form-control" name="borrow_date" id="modal-borrow-date"
